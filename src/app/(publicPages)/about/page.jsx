  ...
  return (
    <>
      <section className="bg-[url(/images/heroBgPattern.svg)] bg-vista-white w-full bg-no-repeat bg-cover">
        <div className="container flex flex-col gap-8 pt-40 pb-24 mx-auto">
          <div className="grid grid-cols-12">
            <div className="flex flex-col col-span-7 gap-6">
              <h1 className="text-[52px] font-semibold  text-gray-800 leading-[60px]">
                Personalized{" "}
      ...
      <section className="py-24">
        <div className="container flex flex-col items-center justify-center gap-4 mx-auto">
          ...
          <h3 className="w-3/4 text-5xl font-bold text-center text-gray-800 leading-16">
            Empowering Better Care Through Clarity, Connection, and Compassion
          </h3>

          <div className="w-full mt-12">
            <div className="p-24 bg-primaryExtraDark rounded-t-4xl">
              <div className="px-12 mb-16">
                <Image src={Images.About.about} alt="" />
              </div>
              <span className="text-2xl block w-fit mb-6 bg-gradient-to-r from-[#C1DFC4] to-[#DEECDD] px-8 py-2.5 rounded-full text-primaryExtraDark ">
                At <strong>ConnectMD</strong>, our mission is simple
              </span>

              <div className="flex flex-col gap-4">
                <h2 className="text-6xl font-semibold text-white leading-16">
      ...
      <section className="pb-24">
        <div className="container flex flex-col gap-10 mx-auto">
          <h2 className="text-6xl font-bold text-center">What We Stand For</h2>
              ...
              <div className="col-span-8">
                <div className="flex flex-col items-start justify-start gap-6 p-12">
                  <div className="relative flex items-center justify-center">
                    <Image src={Images.About.iconWhiteBG} alt="" />
      ...
      <section className="bg-gradient-to-b to-[#A8EDEA09] from-[#9BCFE570] rounded-t-4xl pt-24">
        <div className="container mx-auto">
          <div className="grid grid-cols-12 gap-4">
            <div className="flex flex-col items-center justify-center col-span-12 gap-4 mb-12">
              <h3 className="my-3 text-6xl font-semibold text-center text-gray-800">
                Why It Matters
              </h3>
              <h4 className="w-3/4 text-lg font-normal text-center text-gray-800">
      ...
      <section className=" py-24 bg-black rounded-4xl bg-[url(/images/aboutFooterBanner.jpg)] bg-right bg-contain bg-no-repeat">
        <div className="container mx-auto">
          <div className="grid items-center justify-center grid-cols-12 gap-4 ">
            <div className="flex flex-col col-span-6 gap-8">
              ...
              <div className="py-5 border-l-[5px] rounded-lg bg-emerald-900 px-9 border-emerald-400">
